...
namespace pcl
{
    ...
    public:
        ...
        using signal_Kinect2_PointXYZRGBA = void(const typename pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr&);
        using signal_Kinect2_PointXYZI = void(const typename pcl::PointCloud<pcl::PointXYZI>::ConstPtr&);
