...
\section{MIS of Application Control} \label{ModuleAC} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Point Cloud Data Structures} \label{ModulePCDS} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Input Processing} \label{ModuleIP} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Command Line Interface} \label{ModuleCLI} \wss{Use labels for
  cross-referencing}
...
\section{MIS of Graphical User Interface} \label{ModuleGUI} \wss{Use labels for
  cross-referencing}
